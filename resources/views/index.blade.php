...
@section('content')
    <div class="wrapper">
            ...
            <div class="chisiamo">
                ...
                <div class="testochisiamo">
                    <p>Benvenuti nel sito dell'azienda di coupon!
                        ...
                        Il nostro sito web è progettato per garantire una facile navigazione, con una home page intuitiva che fornisce un'ampia gamma di coupon disponibili.
                        Il nostro catalogo offre un'ampia selezione di offerte, dalle esperienze di viaggio e di ristorazione ai prodotti di bellezza e benessere.
                        Se avete domande, controllate le nostre FAQ in fondo alla pagina, dove troverete tutte le risposte alle domande più frequenti.
        ...
        <h1 class="h1">Paragrafo  yooooooo</h1>
